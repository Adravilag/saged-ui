  ...
  es: {
    ...
    about: {
      ...
      featuresList: {
        ...
        lightweight: 'Ligero',
        lightweightDesc: 'Zero runtime deps, tree-shakeable y optimizado para rendimiento.',
        typescript: 'TypeScript',
        ...
        frameworkAgnosticDesc: 'Funciona con React, Angular o JavaScript vanilla.',
      },
    },
  },
  en: {
    ...
    about: {
      ...
      featuresList: {
        ...
        frameworkAgnosticDesc: 'Works with React, Angular, or vanilla JavaScript.',
      },
    },
  },
};
